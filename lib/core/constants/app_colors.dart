...
class AppColors {
  ...
  static const Color gray700 = Color(0xFF373E42);
  ...
  // 그외 컬러
  static const Color red = Color(0xFFF33838);
  static const Color orange = Color(0xFFEB6F0A);
  static const Color lightOrange = Color(0xFFFFC4A4);
  static const Color yellow = Color(0xFFFEE500);
  static const Color blue = Color(0xFF368FFF);
  static const Color lightBlue = Color(0xFFC2D4EE);
  static const Color lightSkyBlue = Color(0xFFC3E8FE);
}